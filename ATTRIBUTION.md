...
The repository-root common catalog includes canonical curated third-party
skills and provenance for first-party work adapted from upstream.
...
The sources and licenses for `improve-codebase-architecture` and `wizard` were
