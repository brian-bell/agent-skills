...
Run this skill inline as the closeout owner. The helper freezes the target,
uses a temporary snapshot, runs the independent review stages, and returns one
auditable result. Do not delegate the whole skill.
