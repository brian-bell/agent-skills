...
| Max loops | `12` |
| Quality gate | `9/10` |
| Reviewer | fresh-context reviewer agent, equal to or more powerful than the planner |
...
Keep the plan concrete enough that another agent could execute it without rediscovering the problem.
