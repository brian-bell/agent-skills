...
### 4. Use Autofix On Accepted Findings When Requested
...
- Autofix result, pending autofix command, or local action needed for `accepted` findings, and `none` for other decisions.
